#' @title fit_lm
#'
#' @description Fit linear model for each feature as a function of the previously selected features S.
#' The dimensions spanned by the selected features are projected out of the data by setting each feature
